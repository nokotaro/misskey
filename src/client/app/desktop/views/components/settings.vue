...
<div class="mk-settings">
	<div class="nav" :class="{ inWindow }">
		<p :class="{ active: page == 'profile' }" @mousedown="page = 'profile'"><fa :icon="['fal', 'user']" fixed-width/>{{ $t('@._settings.profile') }}</p>
		<p :class="{ active: page == 'appearance' }" @mousedown="page = 'appearance'"><fa :icon="['fal', 'palette']" fixed-width/>{{ $t('@._settings.appearance') }}</p>
		<p :class="{ active: page == 'behavior' }" @mousedown="page = 'behavior'"><fa :icon="['fal', 'desktop']" fixed-width/>{{ $t('@._settings.behavior') }}</p>
		<p :class="{ active: page == 'notification' }" @mousedown="page = 'notification'"><fa :icon="['fal', 'bell']" fixed-width/>{{ $t('@._settings.notification') }}</p>
		...
		<p :class="{ active: page == 'extendedNotification' }" @mousedown="page = 'extendedNotification'"><fa :icon="['fab', 'mastodon']" fixed-width/>{{ $t('@._settings.extended-notification') }}</p>
		<p :class="{ active: page == 'mastodon' }" @mousedown="page = 'mastodon'"><fa :icon="['fal', 'lightbulb']" fixed-width/>Mastodon</p>
		...
		<p :class="{ active: page == 'other' }" @mousedown="page = 'other'"><fa :icon="['fal', 'cogs']" fixed-width/>{{ $t('@._settings.other') }}</p>
	</div>
	<div class="pages">
