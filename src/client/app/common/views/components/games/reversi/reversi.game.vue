...
<div class="xqnhankfuuilcwvhgsopeqncafzsquya">
	...
	<header><b><router-link :to="blackUser | userPage"><mk-user-name :user="blackUser"/></router-link></b><span> <fa :icon="fasCircle"/></span> vs <b><router-link :to="whiteUser | userPage"><mk-user-name :user="whiteUser"/></router-link></b><span> <fa :icon="faCircle"/></span></header>

	<div style="line-height:16px;overflow:hidden">
