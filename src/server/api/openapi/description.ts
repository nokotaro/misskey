...
アプリケーションからAPIを利用する際には、アプリケーションとアプリケーションを利用するユーザーが結び付けられた専用のアクセストークンをtwistaに発行してもらいます。
...
#### 2.ユーザーに認証させる
アプリを使ってもらうには、ユーザーにプロデューサーへのアクセスの許可をもらう必要があります。
